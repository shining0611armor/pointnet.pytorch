...
data, labels = load_data(root_dir, partition)
...
class ModelNetDataset(Dataset):
    def __init__(self, root, npoints=2500, split='train', data_augmentation=True):
        ...
        # Load data and labels using the load_data function
        self.data, self.labels = load_data(root, split)

        # Map labels to classes (This assumes you have a mapping of labels to class names)
        self.cat = {i: i for i in range(40)}  # Assuming 40 classes as in ModelNet40 dataset
